...
<div class="col-sm-2"></div>
        <form action="AirportUpdateSubmit" method="POST">
            ...
            <div class="col-sm-3">
                ...
                <input type="text" pattern="^N?([a-zA-Z0-9-.-'\s]{1,6})$" id="faa" name="faa" title="FAA Code" value="${faa}" required><br/>
                <span> No more than six characters</span><br>
                <label for="airportName">Airport Name:</label><br />
                <input type="text" pattern="^[a-zA-Z0-9-.-'\s]{1,24}$" id="airportName" name="airportName" title="Airport Name" value="${airportName}" required/><br />
                <label for="airportType">Airport Type:</label><br />
                <input type="text" pattern="^[a-zA-Z0-9-.-'\s]{1,24}$" id="airportType" name="airportType" title="Airport Title" value="${airportType}" required/><br />
                <label for="streetAddress">Street Address:</label><br />
                <input type="text" pattern="^[a-zA-Z0-9-.-'\s]{1,24}$" id="streetAddress" name="streetAddress" title="Airport Street" value="${streetAddress}" required/><br />
                <label for="city">City:</label><br />
                <input type="text" pattern="^[a-zA-Z0-9-#-.-'\s]{1,24}$" id="city" name="city" title="Airport City" value="${city}" required/><br />
            </div>
            <div class="col-sm-3">
                <label for="latitude">Latitude:</label><br />
                <input type="text" pattern="{-?\d{1,3}\.\d+}" id="latitude" name="latitude" title="Latitude" value="${latitude}" required/><br />
                <label for="longitude">Longitude:</label><br />
                <input type="text" pattern="{-?\d{1,3}\.\d+}" id="longitude" name="longitude" title="Logitude" value="${longitude}" required/><br />
                <label for="ctaf">CTAF_UNICOM:</label><br />
                <input type="text" pattern="^[a-zA-Z0-9-.-'\s]{1,24}$" id="ctaf" name="ctaf" title="CTAF_UNICOM" value="${ctaf}" required/><br />
                <label for="runwayType">Runway Type:</label><br />
                <input type="text" pattern="^[a-zA-Z0-9-.-'\s]{1,24}$" id="runwayType" name="runwayType" title="Runway Type" value="${runwayType}" required/><br />
                <label for="towerFreq">Tower Frequency:</label><br />
                <input type="text" pattern="^[a-zA-Z0-9-.-'\s]{1,24}$" id="towerFreq" name="towerFreq" title="Tower Frequency" value="${towerFreq}" required/><br />
            ...
            <div class="col-sm-3">
                ...
                <input type="text" pattern="^[a-zA-Z0-9-.-'\s]{1,24}$" id="contactName" name="contactName" title="Contact Name" value="${contactName}" required/><br />
