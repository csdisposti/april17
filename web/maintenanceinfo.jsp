...
<div class="col-sm-4"></div>
        ...
        <div class="col-sm-4">
                ...
                <input type="text" id="scid" name="scid" title="scid" value="016540548-1"><br/>
                <input type="hidden" id="email" name="email" title="email" value="${em}">
                <label for="contot">Contract Total:</label><br />
                <input type="text" id="contot" name="contot" title="contot" value="28699"/><br />
                <label for="constart">Contract Start Date:</label><br />
                <input type="text" id="constart" name="constart" title="constart" value="2016-06-06"/><br />
                <label for="conend">Contract End Date:</label><br />
                <input type="text" id="conend" name="conend" title="conend" value="2016-07-11"/><br />
                 <label for="paymeth">Payment Method:</label><br />
                 <input type="text" id="paymeth" name="paymeth" title="paymeth" value="D"/><br />
            <label for="concomms">Contract Comments:</label><br />
            <textarea rows="10" cols="30" id="concomms" name="concomms" value="Contract complete" title="concomms"></textarea> <br />



            <input type="submit"  class="btn btn-default btn-sp" value="Update Existing Maintenance" />
        </div>
        </form>
