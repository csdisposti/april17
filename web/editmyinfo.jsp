...
<html>
<head>
    <title>edit My Info - Ascend</title>
...
<div class="container-fluid">
    ...
    <div class="row gray">
        ...
        <form action="EditMyInfoSubmit" method="POST">
        ...
        <div class="col-sm-3">
            ...
            <hr>
            <input type="email" id="email" name="email" title="Signup-Email" value="${username}" disabled/><br />
